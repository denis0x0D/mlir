// RUN: mlir-opt -decorate-with-layoutinfo-spirv -split-input-file -verify-diagnostics %s -o - | FileCheck %s
...
spv.module "Logical" "GLSL450" {
  // CHECK: spv.globalVariable @var0 : !spv.ptr<!spv.struct<!spv.struct<!spv.struct<!spv.struct<!spv.struct<i1 [0], i1 [1], f64 [2]> [0], i1 [16]> [0], i1 [24]> [0], i1 [32]> [0], i1 [40]>, Uniform>
  spv.globalVariable @var0 : !spv.ptr<!spv.struct<!spv.struct<!spv.struct<!spv.struct<!spv.struct<i1, i1, f64>, i1>, i1>, i1>, i1>, Uniform>

  // CHECK: spv.globalVariable @var1 : !spv.ptr<!spv.struct<!spv.struct<i16 [0], !spv.struct<i1 [0], f64 [1]> [2], f32 [18]> [0], f32 [24]>, Uniform>
  spv.globalVariable @var1 : !spv.ptr<!spv.struct<!spv.struct<i16, !spv.struct<i1, f64>, f32>, f32>, Uniform>

  // CHECK: spv.globalVariable @var2 : !spv.ptr<!spv.struct<!spv.struct<i16 [0], !spv.struct<i1 [0], !spv.array<16 x !spv.array<16 x i64 [8]> [128]> [1]> [2], f32 [2058]> [0], f32 [2064]>, Uniform>
...
spv.module "Logical" "GLSL450" {
  ...
  // CHECK: spv.globalVariable @var1 : !spv.ptr<!spv.struct<vector<3xi32> [0], f32 [16]>, StorageBuffer>
...
// expected-error @+1 {{Expected Logical addressing model for 'spv.module', but provided Physical32}}
spv.module "Physical32" "GLSL450" {
}
